...
<meta charset="ISO-8859-1">
 ...
 <link rel="icon" type="image/gif/png" href="logo.png">
    ...
    <script src="Components/form2.js"></script>
			     ...
			     <div class="col-lg-4">
				  	 <div class="card" style="width:500px;margin-left:290px;margin-top:40px" >
				  		...
				  		<form style="margin:30px 30px 30px 30px;" id="formInnv2" name="formInnv2">
							...
							Passport number
							<input type="text" class="form-control" name="getPass" id="getPass" placeholder=""><br>					
							
							Bank Name
							<input type="text" class="form-control" name="getbank" id="getbank" placeholder="" ><br>
							
							Provide your Bank Account number
							<input type="text" class="form-control" name="bankNumber" id="bankNumber" placeholder="" ><br>
							
							Address
							<input type="text" class="form-control" name="address"  id="address" placeholder="" ><br>
